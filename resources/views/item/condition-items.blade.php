    ...
    <div class="main-container">
        <div class="pd-ltr-20 xs-pd-20-10">
            ...
            <div class="card-box mb-30">
                <div class="pd-20">
                    <a href="{{ route('kondisiBarang.form', ['param' => 'add', 'id' => Crypt::encrypt('null')]) }}"
                ...
                <div class="pb-20">
                    <table class="data-table table stripe hover nowrap">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th class="table-plus datatable-nosort">Kondisi</th>
                                <th>Keterangan</th>
                                <th>Created At</th>
                                <th>Updated At</th>
                        ...
                        <tbody>
                            ...
                            @foreach ($conditionItems as $item)
                                <tr>
                                    <td>1</td>
                                    <td class="table-plus">{{ $item->kondisi }}</td>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                <a class="dropdown-item"
                                                    href="{{ route('kondisiBarang.form', ['param' => 'edit', 'id' => Crypt::encrypt($item->id)]) }}">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-body text-center font-18">
                            ...
                            <form action="{{ route('kondisiBarang.delete') }}" method="POST">
                                @csrf
                                @method('DELETE')
