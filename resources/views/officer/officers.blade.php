    ...
    <div class="main-container">
        <div class="pd-ltr-20 xs-pd-20-10">
            ...
            <div class="card-box mb-30">
                <div class="pd-20">
                    <a href="{{ route('guruPegawai.form', ['param' => 'add', 'id' => Crypt::encrypt('null')]) }}"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span style="color: #fff;"
                                            class="badge @if ($item->status == 'Aktif') bg-success
                                            @else
                                            bg-danger @endif">
                                            {{ $item->status }}
                                        </span>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                <a class="dropdown-item"
                                                    href="{{ route('guruPegawai.form', ['param' => 'edit', 'id' => Crypt::encrypt($item->id)]) }}">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-body text-center font-18">
                            ...
                            <form action="{{ route('guruPegawai.delete') }}" method="POST">
                                @csrf
                                @method('DELETE')
