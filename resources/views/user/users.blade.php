    ...
    <div class="main-container">
        <div class="pd-ltr-20 xs-pd-20-10">
            ...
            <div class="card-box mb-30">
                <div class="pd-20">
                    <a href="{{ route('pengguna.form', ['param' => 'add', 'id' => Crypt::encrypt('null')]) }}"
                        ...
                        <tbody>
                            ...
                            @foreach ($users as $item)
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            class="text-white badge @if ($item->blokir == 'Y') bg-danger @else bg-success @endif">{{ $item->blokir }}</span>
                                    </td>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                <a class="dropdown-item"
                                                    href="{{ route('pengguna.form', ['param' => 'edit', 'id' => Crypt::encrypt($item->id)]) }}">
